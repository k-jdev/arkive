...
export default function PdfViewer({ file, title }: PdfViewerProps) {
  ...
  const handlePointerMove = useCallback(
    (e: React.PointerEvent) => {
      ...
      const pw = containerWidth * zoom;
      const excessX = (pw - containerWidth) / 2;
  ...
  return (
    ...
    >
      {/* Top bar */}
      <div className="sticky top-12 z-40 flex items-center justify-between px-4 py-3 bg-neutral-950/90 backdrop-blur-md border-b border-white/5">
      ...
      <div
        ref={pageAreaRef}
        className="flex-1 flex flex-col items-center justify-center overflow-auto py-6 px-4 w-full max-w-full"
      >
        {loading && (
      ...
      {/* Bottom nav bar */}
      <div className="sticky bottom-0 flex items-center justify-center gap-4 px-4 py-3 bg-neutral-950/90 backdrop-blur-md border-t border-white/5">
        <button

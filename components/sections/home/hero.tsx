      ...
      <section className="relative w-full h-[120svh] bg-white overflow-hidden">
        ...
        >
          <motion.p
            ...
            variants={heroDarkEnter}
            className="w-[92vw] md:w-[min(65vw,1200px)] text-white font-light [font-family:var(--figma-font-text)] tracking-[-0.4px]"
